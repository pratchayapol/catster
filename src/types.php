            ...
            <tbody>
              ...
              ?>
                  <tr>
                    ...
                    <td>
                      <a href="form_update_type.php?type_id=<?php echo htmlspecialchars($type['type_id']); ?>">
                        <i class="fa-solid fa-pen-to-square" style="margin-right: 10px; color: orange;"></i><span style="color: orange;">Update</span>
                      </a>
                      <br>
                      <a role="button" href="delete_type.php?type_id=<?php echo htmlspecialchars($type['type_id']); ?>" onclick="return confirm('Are you sure you want to delete this product type?');">
                        <i class="fa-regular fa-trash-can" style="margin-right: 10px; color: red;"></i><span style="color: red;">Delete</span>
                      </a>
                    </td>
                  </tr>
                <?php endwhile; ?>

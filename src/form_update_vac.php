...
if (isset($_GET['vac_id'])) {
    ...
    // Redirect to vaccine.php if vac_id is not set
    header('Location: vaccines.php');
    exit;
}
?>
...
<body>
    ...
    <section id="content">
        ...
        <main>
            <div class="head-title">
                <div class="left">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li>
                            <a href="vaccines.php" class="active">Vaccine</a>
                        </li>
                        <li><i class='bx bx-chevron-right'></i></li>
                        <li>
                            <a href="#">Update</a>
            ...
            <form class="form-input" action="update_vac.php" method="POST">
                <div class="row">
                    <div class="col-6">
                        <input type="text" name="vac_id" id="vac_id" style="background-color: #CCC;" value="<?php echo htmlspecialchars($row['vac_id']); ?>" readonly>
                        <input type="text" name="vac_name" id="vac_name" value="<?php echo htmlspecialchars($row['vac_name']); ?>">
                        <textarea rows="3" name="vac_desc" id="vac_desc"><?php echo htmlspecialchars($row['vac_desc']); ?></textarea>
                    </div>
                </div>
                <div class="row">
                    <div class="col-12">
